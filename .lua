...
Path.Text = "Note : This Script is FE and it only FE when RespectFilteringEnabled(RFE) is disabled, mostly RespectFilteringEnabled(RFE) disabled game are classic game, on top you will see if it's FE or not"
Path.TextColor3 = Color3.fromRGB(255, 0, 0)
Path.TextScaled = true
Path.TextSize = 16.000
...
game:GetService("StarterGui"):SetCore("SendNotification", {
	Title = "FEAG";
	Text = "FEAG Loaded,Made By Scripty#2063 modified by sauce_boss01";
	Icon = "";
	Duration = 10; 
	Button1 = "ok";
})
